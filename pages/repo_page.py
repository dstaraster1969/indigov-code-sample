...
class RepoPage:
    ...
    # filter_on_language() fails ~80-90% of the time with StaleElementReferenceException on different
    # elements. The DOM appears to be unchanged. I am unable to come up with a solution that consistently
    # filters the repos.
